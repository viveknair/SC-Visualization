window.timeline = {
  ...
  initialize: function(){ 
    ...
    var special_cases = [{'year':1973, 'title': 'Roe v. Wade', 'search_title' : 'ROE v. WADE', 'description': 'On the issue of abortion', 'alignment':'D'},
     {'year':1993, 'title': 'Brewer v. Williams', 'search_title' : 'BREWER, WARDEN v. WILLIAMS', 'description': 'On the right to counsel', 'alignment':'D'},
     {'year':1954, 'title': 'Brown v. Board of Education', 'search_title' : 'Brown v. Board of Education', 'description': 'Landmark civil rights case', 'alignment':'D'},
     {'year':2003, 'title': 'Grutter v. Bollinger', 'search_title' : 'Grutter v. Bollinger', 'description': 'On affirmative action', 'alignment':'D'},
     {'year':2010, 'title': 'Berghuis v. Thompkins', 'search_title' : 'Berghuis v. Thompkins', 'description': 'On the Miranda rights', 'alignment':'D'}]
    ...
    var descriptionGroup = pathsContainer.selectAll(".description_container")
                            ...
                            .enter().append("g")
                              ...
                              .on("click", function(d){ 
                                ...
                                $('#searchTermField').val(d.search_title);
