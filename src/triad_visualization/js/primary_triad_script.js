...
//  -> name, political direction, vote decision
//  -> direction is either 0 or 1 (conservative or liberal)
//  -> vote is either 0 or 1 (conservative or liberal)

var data = [
  { name: "Monkey", direction: 1, vote: 1 },
  { name: "Brains", direction: 0, vote: 0 },
  { name: "Contro", direction: 1, vote: 0 },
  { name: "Smang",  direction: 0, vote: 1  },
  { name: "Sauce",  direction: 1, vote: 1  },
]
...
constructTriadPaths(svg, data, particular) 
{
  ...
  for (var i = 0; i < data.length; i ++) {
    ...
    if (data[i].direction == data[consideration_value].direction) {
